...
hi Directory guifg=#778899 ctermfg=67 guibg=NONE ctermbg=NONE gui=bold cterm=bold term=bold
...
hi Todo guifg=White ctermfg=15 guibg=DarkGray ctermbg=248 gui=bold cterm=bold term=bold
